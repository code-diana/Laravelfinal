...
<div class="container">
    <div class="row justify-content-center" style="margin-top: 20px">
        <div class="col-md-8">
            ...
            <h1 class="mt-2"><?php echo e($facturaSponsor[0]->name); ?></h1>
            </div>

            <div class="card">
                <div class="card-header" style="background-color: #687ca0;color:white">Datos del sponsor</div>
                <div class="card-body">
                    <p class="card-text"><?php echo e($facturaSponsor[0]->description); ?></p>
                </div>
            </div>
            ...
            <div class="mt-4" style="float:right;font-weight:bold">
                ...
                <?php if($plana_principal == 1): ?>
                    <p style="display:inline;font-size:20px;color:blue" class="price"><?php echo e($importe_total+=30); ?>€</p>
                <?php else: ?>
                    <p style="display:inline;font-size:20px;color:blue" class="price"><?php echo e($importe_total); ?>€</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
