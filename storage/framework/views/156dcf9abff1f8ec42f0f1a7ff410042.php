    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary" id="header">
      ...
      <div class="collapse navbar-collapse" id="navbarText" style="width:100% !important;">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('theraces')); ?>">Carreras</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('clasificaciones')); ?>">Clasificaciones</a>
          </li>
        </ul>
    ...
    <div class="container">
      <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <ul class="nav col-md-4 justify-content-end">
          ...
          <li class="nav-item"><a href="<?php echo e(url('/formAdmin')); ?>" class="nav-link px-2 text-muted">Administration</a></li>
        </ul>
      </footer>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\bikerollSalma\resources\views/layouts/layout.blade.php ENDPATH**/ ?>