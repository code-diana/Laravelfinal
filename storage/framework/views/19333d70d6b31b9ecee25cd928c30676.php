<?php $__env->startSection('content'); ?>
    <div class="container mt-3 air">
        <div class="row">
            <div class="col-lg-12">
                <a href="<?php echo e(url('mostrarSponsors')); ?>" class="btn btn-primary float-right mr-3" style="margin: 10px 0 0 10px;">Ver sponsors</a>
                                ...
                                for (var i = 0; i < opciones.length; i++) {
                                    opciones[i].addEventListener('change', function() {
                                        ...
                                        if (this.value == 1) {
                                            ...
                                            document.getElementById('mensaje').innerHTML = "<p>Se suman 30€ al precio de la carrera</p>";
                                        }
                                        else{
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bikerollSalma\resources\views/admin/sponsors/anyadirSponsor.blade.php ENDPATH**/ ?>